//
// file: mp_stadium_amb.gsc
// description: level ambience script for mp_stadium
// scripter: 
//
...
rink_buzzer()
{
    audio_trigger_damage = GetEnt ("amb_scoreboard_buzzer", "targetname");
     
  //  buzzer = getent("amb_buzzer_origin", "targetname");
	 ...
	 while (1)		
	    {
		  ...
		  //      PrintLn ("BUZZER PLAYS");
		        buzzer = getent("amb_buzzer_origin", "targetname");
		        buzzer playsound ("amb_buzzer");
		        wait .5;	
        }
    }
}