//
// file: mp_hotel_amb.gsc
// description: level ambience script for mp_hotel
// scripter: 
//
...
pot_shoot()
{
    audio_trigger_damage = GetEnt ("amb_pot_damage", "targetname");
	 ...
	 while (1)		
	    {
	    	audio_trigger_damage waittill( "damage", amount, attacker, direction, point, method );
		        pots = getent("amb_pot_origin", "targetname");
		        pots playsound ("evt_pot_impact");
		        wait .5;	
        }
    }
}
...
piano_shoot()
{
    audio_trigger_damage = GetEnt ("amb_piano_damage", "targetname");
    ...
    {		
	 while (1)		
	    {
	    	audio_trigger_damage waittill( "damage", amount, attacker, direction, point, method );
		        piano = getent("amb_piano_origin", "targetname");
		        piano playsound ("evt_piano_impact");
		        wait .5;	
        }
    }
}