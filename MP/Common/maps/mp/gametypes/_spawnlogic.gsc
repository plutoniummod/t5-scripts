...
getSpawnpoint_SafeSpawn( spawnpoints )
{
	...
	for ( i = 0; i < spawnpoints.size; i++ )
	{
		...
		{
			airstrikeDanger = maps\mp\_artillery::getArtilleryDanger( spawnpoint.origin );
...
avoidWeaponDamage(spawnpoints)
{
	...
	for (i = 0; i < spawnpoints.size; i++)
	{
		...
		airstrikeDanger = maps\mp\_artillery::getArtilleryDanger( spawnpoints[i].origin ); // 0 = none, 1 = full, might be > 1 for more than 1 airstrike
