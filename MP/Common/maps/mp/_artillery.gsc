...
init()
{
	...
	//{
	//	maps\mp\gametypes\_hardpoints::registerKillstreak("artillery_mp", "artillery_mp","killstreak_artillery","artillery_used", ::useKillstreakArtillery);
	//	maps\mp\gametypes\_hardpoints::registerKillstreakStrings("artillery_mp", &"MP_EARNED_ARTILLERY", &"MP_ARTILLERY_NOT_AVAILABLE", &"MP_ARTILLERY_INBOUND" );
	//	maps\mp\gametypes\_hardpoints::registerKillstreakDialog("artillery_mp", "mpl_killstreak_artillery", "kls_artillery_used", "","kls_artillery_enemy", "", "kls_artillery_ready");
	//	maps\mp\gametypes\_hardpoints::registerKillstreakDevDvar("artillery_mp", "scr_giveartillery");
	//}
