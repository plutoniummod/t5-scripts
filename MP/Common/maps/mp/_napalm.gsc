...
doNapalm(origin, yaw, owner, team )
{
	...
	influencer_org = targetpos + vector_scale( anglestoforward( direction ), 0 );	// just push forwards some "magic" distance. changed this to 0 as it seems to be centered on the chosen location currently.
