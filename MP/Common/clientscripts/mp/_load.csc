...
main()
{
	...
	//The functions are threaded just in case any of them create 'wait's. Note these functions should not have 'wait's in there 'init' and 'main' functions.
	...
	//level thread clientscripts\mp\_tacticalmask::init();
