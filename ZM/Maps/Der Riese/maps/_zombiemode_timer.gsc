...
start_timer( time, stop_notify )
{
	...
	if( !isDefined( self.stopwatch_elem ) )
	{
		...
		self.stopwatch_elem.horzAlign = "user_left";
		self.stopwatch_elem.vertAlign = "user_top";
		...
		self.stopwatch_elem_glass.horzAlign = "user_left";
		self.stopwatch_elem_glass.vertAlign = "user_top";
