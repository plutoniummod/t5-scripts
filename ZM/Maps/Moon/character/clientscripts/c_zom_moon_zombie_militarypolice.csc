...
matches_me()
{
	if(self.model == "c_zom_moon_militarypolice_body_bloat")
	{
		return true;
	}
...
register_gibs()
{
	...
	gib_spawn.gibSpawn3 = "c_zom_moon_militarypolice_g_rlegspawn";
	gib_spawn.gibSpawnTag3 = "J_Knee_RI";
	gib_spawn.gibSpawn4 = "c_zom_moon_militarypolice_g_llegspawn";
