...
main()
{
	self setModel("c_zom_moon_tech_body_noshirtguts_1");
	self.headModel = codescripts\character::randomElement(xmodelalias\c_zom_moon_heads_alias::main());
	self attach(self.headModel, "", true);
	self.voice = "american";
	self.skeleton = "base";
	self.torsoDmg1 = "c_zom_moon_tech_body_n_g_upclean_1";
	self.torsoDmg2 = "c_zom_moon_tech_body_n_g_rarmoff_1";
	self.torsoDmg3 = "c_zom_moon_tech_body_n_g_larmoff_1";
...
precache()
{
	precacheModel("c_zom_moon_tech_body_noshirtguts_1");
	codescripts\character::precacheModelArray(xmodelalias\c_zom_moon_heads_alias::main());
	precacheModel("c_zom_moon_tech_body_n_g_upclean_1");
	precacheModel("c_zom_moon_tech_body_n_g_rarmoff_1");
	precacheModel("c_zom_moon_tech_body_n_g_larmoff_1");
