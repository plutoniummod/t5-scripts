...
//	trigger_funcs["trigger_coop_warp"] = maps\_utility::trigger_coop_warp;
	...
	/#
	debug_replay( "File: _zombietron_load.gsc. Function: main() - COMPLETE\n" ); 
	#/
...
{
	/#
	debug_replay( "File: _zombietron_load.gsc. Function: onPlayerSpawned()\n" ); 
	#/
	...
	{
		/#
		debug_replay( "File: _zombietron_load.gsc. Function: onPlayerSpawned() - INNER LOOP START\n" ); 

		debug_replay( "File: _zombietron_load.gsc. Function: onPlayerSpawned() - INNER LOOP START WAIT\n" ); 
		#/
		...
		/#
		debug_replay( "File: _zombietron_load.gsc. Function: onPlayerSpawned() - 3\n" ); 
		#/
		...
		/#
		debug_replay( "File: _zombietron_load.gsc. Function: onPlayerSpawned() - 4\n" ); 
		#/
...
//			self thread flashMonitor(); 
		...
		/#
		debug_replay( "File: _zombietron_load.gsc. Function: onPlayerSpawned() - 5\n" ); 
		#/
	}
}
