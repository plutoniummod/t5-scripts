...
trackLoop( look2, look4, look6, look8 )
{
	...
	for(;;)
	{
		...
		// ALEXP_MOD (8/28/09): look limits may have changed, so fix up the previuos deltas
...
//setAnimLookWeight works just like SetAnimLimited on an imaginary anim node that affects the four looking directions.
