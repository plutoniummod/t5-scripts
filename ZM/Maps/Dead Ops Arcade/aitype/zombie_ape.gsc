...
/*QUAKED actor_zombie_ape (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_rus_simianaut_body"
...
main()
{
	...
	character\c_rus_simianaut::main();
}
...
precache()
{
	character\c_rus_simianaut::precache();
