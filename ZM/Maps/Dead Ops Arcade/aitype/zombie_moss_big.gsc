...
/*QUAKED actor_zombie_moss_big (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_sog_mp_body_camo"
...
main()
{
	...
	character\c_zom_snow_camo_zt::main();
}
...
precache()
{
	character\c_zom_snow_camo_zt::precache();
