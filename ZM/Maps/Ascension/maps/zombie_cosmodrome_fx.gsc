...
wind_initial_setting()
{
SetSavedDvar( "wind_global_vector", "140 120 0" );    // change "0 0 0" to your wind vector
SetSavedDvar( "wind_global_low_altitude", -250);    // change 0 to your wind's lower bound
...
precache_scripted_fx()
{
	...
	// Effect for light spin in Gantry area
