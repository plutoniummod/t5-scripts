...
{
	/#
	debug_replay("File: _animatedmodels.gsc. Function: main()\n");
	debug_replay("File: _animatedmodels.gsc. Function: main() - START WAIT waittillframeend\n");
	#/
	...
	/#
	debug_replay("File: _animatedmodels.gsc. Function: main() - STOP WAIT waittillframeend\n");
	#/
	...
	/#
	debug_replay("File: _animatedmodels.gsc. Function: main() - COMPLETE\n");
	#/
}
