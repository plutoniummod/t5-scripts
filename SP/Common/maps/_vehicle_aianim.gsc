...
vehicle_enter( vehicle, tag ) // self == ai
{
...
//		return; // nothing available
//
//	origin = chosenorg.origin;// + vector_scale( vectornormalize( chosenorg.origin - vehicle.origin ), 15 );// move the origin out a bit sometimes the start position of the animation is just inside the colision
