...
init_dummy_spawners()
{
	...
	if( !IsDefined( level.dummy_character_funcs ) )
	{
		...
		level.dummy_character_funcs[ "actor_Civilian_Pentagon_CIA" ]        	  		  = character\c_usa_pent_ciaagent10_noglasses::main;
		level.dummy_character_funcs[ "actor_Civilian_Pentagon_CIA_Chopper" ]        	= character\c_usa_pent_ciaagent6::main;
		level.dummy_character_funcs[ "actor_Civilian_Pentagon_CIA_First_Desk" ]       = character\c_usa_pent_ciaagent5::main;
		level.dummy_character_funcs[ "actor_Civilian_Pentagon_CIA_Second_Desk" ]      = character\c_usa_pent_ciaagent4::main;
		level.dummy_character_funcs[ "actor_Civilian_Pentagon_CIA_Ele_Guard2" ]       = character\c_usa_pent_ciaagent8_noglasses::main;
		level.dummy_character_funcs[ "actor_Civilian_Pentagon_CIA_Ele_Guard1" ]       = character\c_usa_pent_ciaagent2::main;
		level.dummy_character_funcs[ "actor_Civilian_Pentagon_CIA_Inn_Guard1" ]       = character\c_usa_pent_ciaagent3::main;
		level.dummy_character_funcs[ "actor_Civilian_Pentagon_CIA_Inn_Guard2" ]       = character\c_usa_pent_ciaagent9_noglasses::main;
