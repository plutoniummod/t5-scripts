...
{
	/#
	debug_replay("File: _friendlyfire.gsc. Function: main()\n");
	#/
...
//	thread participation_point_flattenovertime(); 
	...
	/#
	debug_replay("File: _friendlyfire.gsc. Function: main() - COMPLETE\n");
	#/
}
...
{
	/#
	debug_replay("File: _friendlyfire.gsc. Function: debug_friendlyfire()\n");
	#/
	...
	for (;;)
	{
		debug_replay("File: _friendlyfire.gsc. Function: debug_friendlyfire() - INNER LOOP START\n");
		...
		debug_replay("File: _friendlyfire.gsc. Function: debug_friendlyfire() - INNER LOOP WAIT\n");
		
		wait( 0.25 ); 
		
		debug_replay("File: _friendlyfire.gsc. Function: debug_friendlyfire() - INNER LOOP STOP\n");
	}
	
	debug_replay("File: _friendlyfire.gsc. Function: debug_friendlyfire() - COMPLLETE\n");
	#/
}
