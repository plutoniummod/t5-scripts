...
//	add_dds_category( "kill_explo",		"killfirm",		1,		"explode_rspns",true,	::dds_sort_ent_dist,	::get_attacker,			1000,	1,	2,	false );
...
//	add_dds_category( "gib",			"gib",				.75,	"explode_rspns",true,	::dds_sort_ent_dist,	::get_attacker,			1000,	.7,	2,	false );
...
//	add_dds_category( "grenade_rspns",	"rspns_grenade_exp",1.25,	"",				true,	::dds_sort_ent_dist,	::get_nearest,			5000,	.7,	0.5,	true );
...
//	add_dds_category_axis( "grenade_rspns",		"rspns_grenade_exp",.75,	"",				true,	::dds_sort_ent_dist,	::get_nearest,			3500,	.7,		2 );
//	add_dds_category_axis( "explode_rspns",		"rspns_kill_exp",	.75,	"",				true,	::dds_sort_ent_dist,	::get_nearest,			3500,	.7,		2 );
...
//	add_dds_category_axis( "friendly_fire",		"frndly_fire",		.75,	"",				true,	::dds_sort_ent_dist,	::get_self_ent,			2000,	.9,		1 );
//	add_dds_category_axis( "civ_fire",			"frndly_fire",		1,		"",				true,	::dds_sort_ent_dist,	::get_nearest_not_plr,	2000,	.9,		1 );

	
	add_dds_category_axis( "kill_melee",		"kill_melee",		.25,	"",				true,	::dds_sort_ent_dist,	::get_attacker,			400,	1,		3 );
//	add_dds_category_axis( "kill_explo",		"kill_explo",		1,		"explode_rspns",true,	::dds_sort_ent_dist,	::get_attacker,			2400,	1,		2 );

//	add_dds_category_axis( "kill_dmg_shot",		"kill_dmg_shot",	1,		"",				true,	::dds_sort_ent_dist,	::get_attacker,			2000,	1,		3 );
//	add_dds_category_axis( "kill_dmg_melee",	"kill_dmg_melee",	1,		"",				true,	::dds_sort_ent_dist,	::get_attacker,			2000,	1,		3 );

	//add_dds_category_axis( "killstreak",		"kllstrk",			.75,	"",				true,	::dds_sort_ent_dist,	::get_nearest_not_plr,	1000,	.8,		2 );
//	add_dds_category_axis( "gib",				"gib",				1,		"explode_rspns",true,	::dds_sort_ent_dist,	::get_attacker,			2000,	1,		1 );
//	add_dds_category_axis( "multikill",			"multkill",			1,		"",				true,	::dds_sort_ent_dist,	::get_nearest_not_plr,	2000,	1,		2 );
...
dds_notify( category_name, isAlliesLine ) //self == ent calling notify
{
	...
	//assertEx( IsDefined( level.dds.active_events[category_name] ), "didn't setup " + category_name + " as a category type." );
	//assertEx( IsDefined( level.dds.active_events_axis[category_name] ), "didn't setup " + category_name + " as a category type." );
