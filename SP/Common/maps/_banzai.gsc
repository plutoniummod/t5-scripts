...
init()
{
	...
	//PrecacheModel( "weapon_usa_kbar_knife" ); AE 3-4-09: commented this out b/c the model doesn't exist in t5
...
// SCRIPTER_MOD: dguzzo: 4/6/2009 : script_forcegoal removed
