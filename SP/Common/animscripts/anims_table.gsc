					...
					for( animIndex = 0; animIndex < animKeys.size; animIndex++ )
					{
						...
						if( IsArray(anim_array) )
						{
							...
							for( transIndex = 0; transIndex < transKeys.size; transIndex++ )
							{
								...
								if( isSubStr(animName, "exposed") || (!isSubStr(animName, "mini") && trans >= 1 && trans <= 9) )
								{
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	array[animType]["combat"]["stand"]["rifle"]["exposed_idle"]				= array( %exposed_idle_alert_v1, %exposed_idle_alert_v2, %exposed_idle_alert_v3, %ai_stand_exposed_idle_movement, %ai_stand_exposed_idle_movement, %ai_stand_exposed_idle_movement, %ai_stand_exposed_idle_movement, %ai_stand_exposed_idle_movement );
	array[animType]["combat"]["stand"]["rifle"]["exposed_idle_noncombat"]	= array( %exposed_idle_alert_v1, %exposed_idle_alert_v2, %exposed_idle_alert_v3, %ai_stand_exposed_idle_movement, %ai_stand_exposed_idle_movement, %ai_stand_exposed_idle_movement, %ai_stand_exposed_idle_movement, %ai_stand_exposed_idle_movement );
	...
	array[animType]["combat"]["stand"]["rifle"]["grenade_throw"]			= %stand_grenade_throw;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// ALEXP_TODO: add these toploading anims. The weapon anims below may override this
	// if ( self usingTopLoadingWeapon() )
	//array[animType]["combat"]["stand"]["rifle"]["reload"]					= array( %exposed_topload );
	//array[animType]["combat"]["stand"]["rifle"]["reload_crouchhide"]		= array( %exposed_topload ); 
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	array[animType]["combat"]["stand"]["pistol"]["fire"]					= %pistol_stand_fire_A;
	array[animType]["combat"]["stand"]["pistol"]["single"]					= array( %pistol_stand_fire_A );
	array[animType]["combat"]["stand"]["pistol"]["semi2"]					= %pistol_stand_fire_A;
	array[animType]["combat"]["stand"]["pistol"]["semi3"]					= %pistol_stand_fire_A;
	array[animType]["combat"]["stand"]["pistol"]["semi4"]					= %pistol_stand_fire_A;
	array[animType]["combat"]["stand"]["pistol"]["semi5"]					= %pistol_stand_fire_A;

	array[animType]["combat"]["stand"]["pistol"]["reload"]					= array( %pistol_stand_reload_A );
	array[animType]["combat"]["stand"]["pistol"]["reload_crouchhide"]		= array();
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	array[animType]["combat"]["stand"]["spread"]["reload"]					= array( %shotgun_stand_reload_A, %shotgun_stand_reload_B, %shotgun_stand_reload_C, %shotgun_stand_reload_C, %shotgun_stand_reload_C ); // (C is standing, want it more often)
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// ALEXP_TODO: hook this up // if ( self isCQBWalking() || self is_banzai() )
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	array[animType]["combat"]["stand"]["rifle"]["bayonet"]					= %ai_bayonet_stab_melee;
	...
	array[animType]["combat"]["stand"]["rifle"]["ai_vs_ai_win"]				= %bog_melee_R_attack;
	array[animType]["combat"]["stand"]["rifle"]["ai_vs_ai_lose"]			= %bog_melee_R_defend;
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// ALEXP_TODO: add these toploading anims. The weapon anims below may override this
	// if ( self usingTopLoadingWeapon() )
	//array[animType]["combat"]["crouch"]["rifle"]["reload"]				= array( %exposed_crouch_topload );
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	array[animType]["move"]["stand"]["rifle"]["combat_run_lean_l"]			= %ai_run_lowready_f_lean_l;
	array[animType]["move"]["stand"]["rifle"]["combat_run_lean_r"]			= %ai_run_lowready_f_lean_r;
	...
	array[animType]["move"]["stand"]["rifle"]["sprint"]						= %ai_sprint_f;
	...
	array[animType]["move"]["stand"]["rifle"]["cqb_run_f"]					= array( %run_CQB_F_search_v1, %run_CQB_F_search_v2 );
	...
	array[animType]["move"]["crouch"]["rifle"]["combat_run_lean_l"]			= %crouch_fastwalk_L;
	array[animType]["move"]["crouch"]["rifle"]["combat_run_lean_r"]			= %crouch_fastwalk_R;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	array[animType]["move"]["stand"]["rifle"]["arrive_pillar"][1]			= %ai_pillar_stand_arrive_1;
	array[animType]["move"]["stand"]["rifle"]["arrive_pillar"][2]			= %ai_pillar_stand_arrive_2;
	array[animType]["move"]["stand"]["rifle"]["arrive_pillar"][3]			= %ai_pillar_stand_arrive_3;
	array[animType]["move"]["stand"]["rifle"]["arrive_pillar"][4]			= %ai_pillar_stand_arrive_4;
	array[animType]["move"]["stand"]["rifle"]["arrive_pillar"][6]			= %ai_pillar_stand_arrive_6;
	array[animType]["move"]["stand"]["rifle"]["arrive_pillar"][7]			= %ai_pillar_stand_arrive_7;
	array[animType]["move"]["stand"]["rifle"]["arrive_pillar"][8]			= %ai_pillar_stand_arrive_8r;
	array[animType]["move"]["stand"]["rifle"]["arrive_pillar"][9]			= %ai_pillar_stand_arrive_9;

	array[animType]["move"]["stand"]["rifle"]["arrive_pillar_crouch"][1]	= %ai_pillar_crouch_arrive_1;
	array[animType]["move"]["stand"]["rifle"]["arrive_pillar_crouch"][2]	= %ai_pillar_crouch_arrive_2;
	array[animType]["move"]["stand"]["rifle"]["arrive_pillar_crouch"][3]	= %ai_pillar_crouch_arrive_3;
	array[animType]["move"]["stand"]["rifle"]["arrive_pillar_crouch"][4]	= %ai_pillar_crouch_arrive_4;
	array[animType]["move"]["stand"]["rifle"]["arrive_pillar_crouch"][6]	= %ai_pillar_crouch_arrive_6;
	array[animType]["move"]["stand"]["rifle"]["arrive_pillar_crouch"][7]	= %ai_pillar_crouch_arrive_7;
	array[animType]["move"]["stand"]["rifle"]["arrive_pillar_crouch"][8]	= %ai_pillar_crouch_arrive_8r;
	array[animType]["move"]["stand"]["rifle"]["arrive_pillar_crouch"][9]	= %ai_pillar_crouch_arrive_9;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	array[animType]["move"]["stand"]["rifle"]["exit_pillar"][1]				= %ai_pillar_stand_exit_1;
	array[animType]["move"]["stand"]["rifle"]["exit_pillar"][2]				= %ai_pillar_stand_exit_2;
	array[animType]["move"]["stand"]["rifle"]["exit_pillar"][3]				= %ai_pillar_stand_exit_3;
	array[animType]["move"]["stand"]["rifle"]["exit_pillar"][4]				= %ai_pillar_stand_exit_4;
	array[animType]["move"]["stand"]["rifle"]["exit_pillar"][6]				= %ai_pillar_stand_exit_6;
	array[animType]["move"]["stand"]["rifle"]["exit_pillar"][7]				= %ai_pillar_stand_exit_7;
	array[animType]["move"]["stand"]["rifle"]["exit_pillar"][8]				= %ai_pillar_stand_exit_8r;
	array[animType]["move"]["stand"]["rifle"]["exit_pillar"][9]				= %ai_pillar_stand_exit_9;

	array[animType]["move"]["stand"]["rifle"]["exit_pillar_crouch"][1]		= %ai_pillar_crouch_exit_1;
	array[animType]["move"]["stand"]["rifle"]["exit_pillar_crouch"][2]		= %ai_pillar_crouch_exit_2;
	array[animType]["move"]["stand"]["rifle"]["exit_pillar_crouch"][3]		= %ai_pillar_crouch_exit_3;
	array[animType]["move"]["stand"]["rifle"]["exit_pillar_crouch"][4]		= %ai_pillar_crouch_exit_4;
	array[animType]["move"]["stand"]["rifle"]["exit_pillar_crouch"][6]		= %ai_pillar_crouch_exit_6;
	array[animType]["move"]["stand"]["rifle"]["exit_pillar_crouch"][7]		= %ai_pillar_crouch_exit_7;
	array[animType]["move"]["stand"]["rifle"]["exit_pillar_crouch"][8]		= %ai_pillar_crouch_exit_8r;
	array[animType]["move"]["stand"]["rifle"]["exit_pillar_crouch"][9]		= %ai_pillar_crouch_exit_9;
	...
	// we need 45 degree angle approaches for exposed...
	array[animType]["move"]["stand"]["rifle"]["exit_exposed"][2]			= %stand_2_run_180_med;
	array[animType]["move"]["stand"]["rifle"]["exit_exposed"][4]			= %stand_2_run_L;
	array[animType]["move"]["stand"]["rifle"]["exit_exposed"][6]			= %stand_2_run_R;
	array[animType]["move"]["stand"]["rifle"]["exit_exposed"][8]			= %stand_2_run_F_2;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	array[animType]["stop"]["stand"]["rifle"]["idle_trans"]					= %casual_stand_idle_trans_in;
	...
	array[animType]["stop"]["stand"]["rifle"]["idle_banzai"]				= array( array(%cqb_stand_idle, %cqb_stand_idle, %cqb_stand_twitch) );	
	...
	array[animType]["stop"]["crouch"]["rifle"]["idle_trans"]				= %casual_crouch_idle_in;
...
//	if ( self usingTopLoadingWeapon() )
//	{
//		array[animType]["cover_left"]["stand"]["rifle"]["reload"]			= array( %CornerStndL_topload );
//		array[animType]["cover_left"]["stand"]["rifle"]["lean_reload"]		= %CornerStndL_lean_topload;
//	}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// cover-left specific
	array[animType]["cover_left"]["crouch"]["rifle"]["lean_fire"]			= %CornerStndL_lean_auto;
	array[animType]["cover_left"]["crouch"]["rifle"]["lean_semi2"]			= %CornerStndL_lean_auto;
	array[animType]["cover_left"]["crouch"]["rifle"]["lean_semi3"]			= %CornerStndL_lean_auto;
	array[animType]["cover_left"]["crouch"]["rifle"]["lean_semi4"]			= %CornerStndL_lean_auto;
	array[animType]["cover_left"]["crouch"]["rifle"]["lean_semi5"]			= %CornerStndL_lean_auto;
	array[animType]["cover_left"]["crouch"]["rifle"]["lean_burst2"]			= %CornerStndL_lean_auto;
	array[animType]["cover_left"]["crouch"]["rifle"]["lean_burst3"]			= %CornerStndL_lean_auto;
	array[animType]["cover_left"]["crouch"]["rifle"]["lean_burst4"]			= %CornerStndL_lean_auto;
	array[animType]["cover_left"]["crouch"]["rifle"]["lean_burst5"]			= %CornerStndL_lean_auto;
	array[animType]["cover_left"]["crouch"]["rifle"]["lean_burst6"]			= %CornerStndL_lean_auto;
	array[animType]["cover_left"]["crouch"]["rifle"]["lean_single"]			= array( %CornerStndL_lean_fire );

	array[animType]["cover_left"]["crouch"]["rifle"]["lean_aim_down"]		= %ai_cover_crouch_suppressed_l_aim2;
	array[animType]["cover_left"]["crouch"]["rifle"]["lean_aim_left"]		= %ai_cover_crouch_suppressed_l_aim4;
	array[animType]["cover_left"]["crouch"]["rifle"]["lean_aim_straight"]	= %ai_cover_crouch_suppressed_l_aim5;
	array[animType]["cover_left"]["crouch"]["rifle"]["lean_aim_right"]		= %ai_cover_crouch_suppressed_l_aim6;
	array[animType]["cover_left"]["crouch"]["rifle"]["lean_aim_up"]			= %ai_cover_crouch_suppressed_l_aim8;
	
	array[animType]["cover_left"]["crouch"]["rifle"]["lean_idle"]			= array( %ai_cover_crouch_suppressed_l_aim5_idle );
	...
	array[animType]["cover_left"]["crouch"]["rifle"]["lean_to_alert"]		= array( %ai_cover_crouch_suppressed_l_aim5_2_cover );
	array[animType]["cover_left"]["crouch"]["rifle"]["alert_to_lean"]		= array( %ai_cover_crouch_suppressed_l_trans_2_aim5 );
...
//	array[animType]["cover_right"]["crouch"]["rifle"]["look_idle"]			= %CornerCrR_look_idle; // TODO
	...
	array[animType]["cover_left"]["crouch"]["rifle"]["blind_fire"]			= array( %ai_cover_crouch_suppressed_l_blindfire_01, %ai_cover_crouch_suppressed_l_blindfire_02 );
...
//	if ( self usingTopLoadingWeapon() )
//	{
//		array[animType]["cover_left"]["crouch"]["rifle"]["reload"]			= array( %CornerCrL_toploadA, %CornerCrL_toploadB );
//	}
...
//	array[animType]["cover_right"]["stand"]["rifle"]["look"]				= %corner_standR_look;
	...
	array[animType]["cover_right"]["stand"]["rifle"]["stance_change"]		= %CornerCrL_stand_2_alert;
...
//	if ( self usingTopLoadingWeapon() )
//	{
//		array[animType]["cover_right"]["stand"]["rifle"]["reload"]		= array( %CornerStndR_topload );
//		array[animType]["cover_right"]["stand"]["rifle"]["lean_reload"]	= %CornerStndR_lean_topload;
//	}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// cover-right specific
	array[animType]["cover_right"]["crouch"]["rifle"]["lean_fire"]			= %CornerStndL_lean_auto;
	array[animType]["cover_right"]["crouch"]["rifle"]["lean_semi2"]			= %CornerStndL_lean_auto;
	array[animType]["cover_right"]["crouch"]["rifle"]["lean_semi3"]			= %CornerStndL_lean_auto;
	array[animType]["cover_right"]["crouch"]["rifle"]["lean_semi4"]			= %CornerStndL_lean_auto;
	array[animType]["cover_right"]["crouch"]["rifle"]["lean_semi5"]			= %CornerStndL_lean_auto;
	array[animType]["cover_right"]["crouch"]["rifle"]["lean_burst2"]		= %CornerStndL_lean_auto;
	array[animType]["cover_right"]["crouch"]["rifle"]["lean_burst3"]		= %CornerStndL_lean_auto;
	array[animType]["cover_right"]["crouch"]["rifle"]["lean_burst4"]		= %CornerStndL_lean_auto;
	array[animType]["cover_right"]["crouch"]["rifle"]["lean_burst5"]		= %CornerStndL_lean_auto;
	array[animType]["cover_right"]["crouch"]["rifle"]["lean_burst6"]		= %CornerStndL_lean_auto;
	array[animType]["cover_right"]["crouch"]["rifle"]["lean_single"]		= array( %CornerStndL_lean_fire );

	array[animType]["cover_right"]["crouch"]["rifle"]["lean_aim_down"]		= %ai_cover_crouch_suppressed_r_aim2;
	array[animType]["cover_right"]["crouch"]["rifle"]["lean_aim_left"]		= %ai_cover_crouch_suppressed_r_aim4;
	array[animType]["cover_right"]["crouch"]["rifle"]["lean_aim_straight"]	= %ai_cover_crouch_suppressed_r_aim5;
	array[animType]["cover_right"]["crouch"]["rifle"]["lean_aim_right"]		= %ai_cover_crouch_suppressed_r_aim6;
	array[animType]["cover_right"]["crouch"]["rifle"]["lean_aim_up"]		= %ai_cover_crouch_suppressed_r_aim8;
	
	array[animType]["cover_right"]["crouch"]["rifle"]["lean_idle"]			= array( %ai_cover_crouch_suppressed_r_aim5_idle );
	...
	array[animType]["cover_right"]["crouch"]["rifle"]["lean_to_alert"]		= array( %ai_cover_crouch_suppressed_r_aim5_2_cover );
	array[animType]["cover_right"]["crouch"]["rifle"]["alert_to_lean"]		= array( %ai_cover_crouch_suppressed_r_trans_2_aim5 );
	...
	array[animType]["cover_right"]["crouch"]["rifle"]["blind_fire"]			= array( %ai_cover_crouch_suppressed_r_blindfire_01, %ai_cover_crouch_suppressed_r_blindfire_02 );
...
//	if ( self usingTopLoadingWeapon() )
//	{
//		array[animType]["cover_right"]["crouch"]["rifle"]["reload"] = array( %CornerCrR_toploadA, %CornerCrR_toploadB );
//	}
...
//	if ( self usingTopLoadingWeapon() )
//	{
//		array[animType]["cover_stand"]["stand"]["rifle"]["reload"]				= %coverstand_topload;
//	}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//	if ( self usingTopLoadingWeapon() )
//	{
//		array[animType]["cover_stand"]["crouch"]["rifle"]["reload"]				= %covercrouch_topload_hide;
//	}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	array[animType]["cover_crouch"]["crouch"]["rifle"]["blind_fire"]		= array( %covercrouch_blindfire_1, %covercrouch_blindfire_2, %covercrouch_blindfire_3, %covercrouch_blindfire_4 );
...
//	if ( self usingTopLoadingWeapon() )
//	{
//		array[animType]["cover_crouch"]["crouch"]["rifle"]["reload"]				= %covercrouch_topload_hide;
//	}
...
//	if ( self usingTopLoadingWeapon() )
//	{
//		array[animType]["cover_crouch"]["stand"]["rifle"]["reload"]				= %coverstand_topload;
//	}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["lean_fire"]				= %ai_pillar_stand_shoot_auto_l;
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["lean_semi2"]			= %ai_pillar_stand_shoot_semi2_l;
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["lean_semi3"]			= %ai_pillar_stand_shoot_semi3_l;
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["lean_semi4"]			= %ai_pillar_stand_shoot_semi4_l;
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["lean_semi5"]			= %ai_pillar_stand_shoot_semi5_l;

	array[animType]["cover_pillar_left"]["stand"]["rifle"]["lean_burst2"]			= %ai_pillar_stand_shoot_burst3_l;
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["lean_burst3"]			= %ai_pillar_stand_shoot_burst3_l;
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["lean_burst4"]			= %ai_pillar_stand_shoot_burst4_l;
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["lean_burst5"]			= %ai_pillar_stand_shoot_burst5_l;
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["lean_burst6"]			= %ai_pillar_stand_shoot_burst6_l;
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["lean_single"]			= array( %ai_pillar_stand_shoot_semi1_l );

	array[animType]["cover_pillar_left"]["stand"]["rifle"]["lean_aim_down"]			= %ai_pillar_stand_aim2_l;
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["lean_aim_left"]			= %ai_pillar_stand_aim4_l;
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["lean_aim_straight"]		= %ai_pillar_stand_aim5_l_idle;
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["lean_aim_right"]		= %ai_pillar_stand_aim6_l;
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["lean_aim_up"]			= %ai_pillar_stand_aim8_l;

	array[animType]["cover_pillar_left"]["stand"]["rifle"]["alert_to_A"]			= array( %ai_pillar_cornerstndl_trans_alert_2_a );
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["alert_to_B"]			= array( %ai_pillar_cornerstndl_trans_alert_2_b );
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["A_to_alert"]			= array( %ai_pillar_cornerstndl_trans_a_2_alert );
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["A_to_alert_reload"]		= array();
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["A_to_B"    ]			= array( %ai_pillar_cornerstndl_trans_a_2_b     );
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["B_to_alert"]			= array( %ai_pillar_cornerstndl_trans_b_2_alert );
 	array[animType]["cover_pillar_left"]["stand"]["rifle"]["B_to_alert_reload"]		= array();
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["B_to_A"    ]			= array( %ai_pillar_cornerstndl_trans_b_2_a     );
	
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["alert_idle"]			= %ai_pillar_stand_idle;
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["alert_idle_twitch"]		= array(
																						%ai_pillar_stand_idle_twitch_02,
																						%ai_pillar_stand_idle_twitch_03
																					);
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["lean_idle"]				= array( %ai_pillar_stand_aim5_l );

	array[animType]["cover_pillar_left"]["stand"]["rifle"]["alert_to_lean"]			= array( %ai_pillar_stand_idle_2_aim5_l );
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["lean_to_alert"]			= array( %ai_pillar_stand_aim5_l_2_idle );

	array[animType]["cover_pillar_left"]["stand"]["rifle"]["look"]					= %ai_pillar_stand_idle_twitch_01;
	
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["reload"]				= array( %ai_pillar_stand_reload_01, %ai_pillar_stand_reload_02, %ai_pillar_stand_reload_03 );
	
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["stance_change"]			= %ai_pillar_stand_idle_2_crouch_idle;

	array[animType]["cover_pillar_left"]["stand"]["rifle"]["grenade_exposed"]		= %ai_pillar_stand_grenade_throw_01;
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["grenade_safe"]			= %ai_pillar_stand_grenade_throw_03;
	array[animType]["cover_pillar_left"]["stand"]["rifle"]["grenade_throw"]			= %stand_grenade_throw;
	
	array[animType]["pain"]["stand"]["rifle"]["cover_pillar_l_remain"]				= %ai_pillar_stand_pain_l_remain;
	array[animType]["pain"]["stand"]["rifle"]["cover_pillar_l_return"]				= %ai_pillar_stand_pain_l_return;
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["lean_fire"]			= %ai_pillar_crouch_shoot_auto_l;
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["lean_semi2"]			= %ai_pillar_crouch_shoot_semi2_l;
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["lean_semi3"]			= %ai_pillar_crouch_shoot_semi3_l;
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["lean_semi4"]			= %ai_pillar_crouch_shoot_semi4_l;
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["lean_semi5"]			= %ai_pillar_crouch_shoot_semi5_l;

	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["lean_burst2"]			= %ai_pillar_crouch_shoot_burst3_l;
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["lean_burst3"]			= %ai_pillar_crouch_shoot_burst3_l;
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["lean_burst4"]			= %ai_pillar_crouch_shoot_burst4_l;
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["lean_burst5"]			= %ai_pillar_crouch_shoot_burst5_l;
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["lean_burst6"]			= %ai_pillar_crouch_shoot_burst6_l;
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["lean_single"]			= array( %ai_pillar_crouch_shoot_semi1_l );

	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["lean_aim_down"]		= %ai_pillar_crouch_aim2_l;
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["lean_aim_left"]		= %ai_pillar_crouch_aim4_l;
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["lean_aim_straight"]	= %ai_pillar_crouch_aim5_l_idle;
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["lean_aim_right"]		= %ai_pillar_crouch_aim6_l;
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["lean_aim_up"]			= %ai_pillar_crouch_aim8_l;

	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["alert_to_A"]			= array( %ai_pillar_cornercrl_trans_alert_2_a );
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["alert_to_B"]			= array( %ai_pillar_cornercrl_trans_alert_2_b );
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["A_to_alert"]			= array( %ai_pillar_cornercrl_trans_a_2_alert );
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["A_to_alert_reload"]	= array();
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["A_to_B"    ]			= array( %ai_pillar_cornercrl_trans_a_2_b     );
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["B_to_alert"]			= array( %ai_pillar_cornercrl_trans_b_2_alert );
 	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["B_to_alert_reload"]	= array();
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["B_to_A"    ]			= array( %ai_pillar_cornercrl_trans_b_2_a     );
	
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["alert_idle"]			= %ai_pillar_crouch_idle;
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["alert_idle_twitch"]	= array(
																						%ai_pillar_crouch_idle_twitch_02,
																						%ai_pillar_crouch_idle_twitch_03
																					);
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["lean_idle"]			= array( %ai_pillar_crouch_aim5_l );

	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["reload"]				= array( %ai_pillar_crouch_reload_01, %ai_pillar_crouch_reload_02, %ai_pillar_crouch_reload_03 );

	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["alert_to_lean"]		= array( %ai_pillar_crouch_idle_2_aim5_l );
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["lean_to_alert"]		= array( %ai_pillar_crouch_aim5_l_2_idle );

	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["look"]					= %ai_pillar_crouch_idle_twitch_01;

	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["stance_change"]		= %ai_pillar_crouch_idle_2_stand_idle;

	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["grenade_exposed"]		= %ai_pillar_crouch_grenade_throw_02;
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["grenade_safe"]			= %ai_pillar_crouch_grenade_throw_03;
	array[animType]["cover_pillar_left"]["crouch"]["rifle"]["grenade_throw"]		= %crouch_grenade_throw;

	array[animType]["pain"]["crouch"]["rifle"]["cover_pillar_l_remain"]				= %ai_pillar_crouch_pain_l_remain;
	array[animType]["pain"]["crouch"]["rifle"]["cover_pillar_l_return"]				= %ai_pillar_crouch_pain_l_return;
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["lean_fire"]			= %ai_pillar_stand_shoot_auto_r;
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["lean_semi2"]			= %ai_pillar_stand_shoot_semi2_r;
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["lean_semi3"]			= %ai_pillar_stand_shoot_semi3_r;
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["lean_semi4"]			= %ai_pillar_stand_shoot_semi4_r;
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["lean_semi5"]			= %ai_pillar_stand_shoot_semi5_r;

	array[animType]["cover_pillar_right"]["stand"]["rifle"]["lean_burst2"]			= %ai_pillar_stand_shoot_burst3_r;
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["lean_burst3"]			= %ai_pillar_stand_shoot_burst3_r;
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["lean_burst4"]			= %ai_pillar_stand_shoot_burst4_r;
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["lean_burst5"]			= %ai_pillar_stand_shoot_burst5_r;
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["lean_burst6"]			= %ai_pillar_stand_shoot_burst6_r;
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["lean_single"]			= array( %ai_pillar_stand_shoot_semi1_r );

	array[animType]["cover_pillar_right"]["stand"]["rifle"]["lean_aim_down"]		= %ai_pillar_stand_aim2_r;
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["lean_aim_left"]		= %ai_pillar_stand_aim4_r;
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["lean_aim_straight"]	= %ai_pillar_stand_aim5_r_idle;
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["lean_aim_right"]		= %ai_pillar_stand_aim6_r;
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["lean_aim_up"]			= %ai_pillar_stand_aim8_r;

	array[animType]["cover_pillar_right"]["stand"]["rifle"]["alert_to_A"]			= array( %ai_pillar_cornerstndr_trans_alert_2_a );
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["alert_to_B"]			= array( %ai_pillar_cornerstndr_trans_alert_2_b );
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["A_to_alert"]			= array( %ai_pillar_cornerstndr_trans_a_2_alert );
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["A_to_alert_reload"]	= array();
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["A_to_B"    ]			= array( %ai_pillar_cornerstndr_trans_a_2_b     );
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["B_to_alert"]			= array( %ai_pillar_cornerstndr_trans_b_2_alert );
 	array[animType]["cover_pillar_right"]["stand"]["rifle"]["B_to_alert_reload"]	= array();
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["B_to_A"    ]			= array( %ai_pillar_cornerstndr_trans_b_2_a     );

	array[animType]["cover_pillar_right"]["stand"]["rifle"]["alert_idle"]			= %ai_pillar_stand_idle;
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["alert_idle_twitch"]	= array(
																						%ai_pillar_stand_idle_twitch_02,
																						%ai_pillar_stand_idle_twitch_03
																					);
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["lean_idle"]			= array( %ai_pillar_stand_aim5_r );

	array[animType]["cover_pillar_right"]["stand"]["rifle"]["alert_to_lean"]		= array( %ai_pillar_stand_idle_2_aim5_r );
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["lean_to_alert"]		= array( %ai_pillar_stand_aim5_r_2_idle );

	array[animType]["cover_pillar_right"]["stand"]["rifle"]["look"]					= %ai_pillar_stand_idle_twitch_01;
	
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["reload"]				= array( %ai_pillar_stand_reload_01, %ai_pillar_stand_reload_02, %ai_pillar_stand_reload_03 );
	
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["stance_change"]		= %ai_pillar_stand_idle_2_crouch_idle;

	array[animType]["cover_pillar_right"]["stand"]["rifle"]["grenade_exposed"]		= %ai_pillar_stand_grenade_throw_01;
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["grenade_safe"]			= %ai_pillar_stand_grenade_throw_03;
	array[animType]["cover_pillar_right"]["stand"]["rifle"]["grenade_throw"]		= %stand_grenade_throw;

	array[animType]["pain"]["stand"]["rifle"]["cover_pillar_r_remain"]				= %ai_pillar_stand_pain_r_remain;
	array[animType]["pain"]["stand"]["rifle"]["cover_pillar_r_return"]				= %ai_pillar_stand_pain_r_return;

	array[animType]["death"]["stand"]["rifle"]["cover_pillar_front"]				= array( %ai_pillar_stand_death_idle );
	array[animType]["death"]["stand"]["rifle"]["cover_pillar_left"]					= array( %ai_pillar_stand_death_left );
	array[animType]["death"]["stand"]["rifle"]["cover_pillar_right"]				= array( %ai_pillar_stand_death_right );
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["lean_fire"]			= %ai_pillar_crouch_shoot_auto_r;
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["lean_semi2"]			= %ai_pillar_crouch_shoot_semi2_r;
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["lean_semi3"]			= %ai_pillar_crouch_shoot_semi3_r;
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["lean_semi4"]			= %ai_pillar_crouch_shoot_semi4_r;
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["lean_semi5"]			= %ai_pillar_crouch_shoot_semi5_r;

	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["lean_burst2"]			= %ai_pillar_crouch_shoot_burst3_r;
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["lean_burst3"]			= %ai_pillar_crouch_shoot_burst3_r;
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["lean_burst4"]			= %ai_pillar_crouch_shoot_burst4_r;
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["lean_burst5"]			= %ai_pillar_crouch_shoot_burst5_r;
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["lean_burst6"]			= %ai_pillar_crouch_shoot_burst6_r;
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["lean_single"]			= array( %ai_pillar_crouch_shoot_semi1_r );

	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["lean_aim_down"]		= %ai_pillar_crouch_aim2_r;
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["lean_aim_left"]		= %ai_pillar_crouch_aim4_r;
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["lean_aim_straight"]	= %ai_pillar_crouch_aim5_r_idle;
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["lean_aim_right"]		= %ai_pillar_crouch_aim6_r;
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["lean_aim_up"]			= %ai_pillar_crouch_aim8_r;

	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["alert_to_A"]			= array( %ai_pillar_cornercrouchr_trans_alert_2_a );
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["alert_to_B"]			= array( %ai_pillar_cornercrouchr_trans_alert_2_b );
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["A_to_alert"]			= array( %ai_pillar_cornercrouchr_trans_a_2_alert );
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["A_to_alert_reload"]	= array();
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["A_to_B"    ]			= array( %ai_pillar_cornercrouchr_trans_a_2_b     );
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["B_to_alert"]			= array( %ai_pillar_cornercrouchr_trans_b_2_alert );
 	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["B_to_alert_reload"]	= array();
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["B_to_A"    ]			= array( %ai_pillar_cornercrouchr_trans_b_2_a     );

	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["alert_idle"]			= %ai_pillar_crouch_idle;
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["alert_idle_twitch"]	= array(
																						%ai_pillar_crouch_idle_twitch_02,
																						%ai_pillar_crouch_idle_twitch_03
																					);
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["lean_idle"]			= array( %ai_pillar_crouch_aim5_r );

	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["reload"]				= array( %ai_pillar_crouch_reload_01, %ai_pillar_crouch_reload_02, %ai_pillar_crouch_reload_03 );

	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["alert_to_lean"]		= array( %ai_pillar_crouch_idle_2_aim5_r );
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["lean_to_alert"]		= array( %ai_pillar_crouch_aim5_r_2_idle );

	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["look"]				= %ai_pillar_crouch_idle_twitch_01;

	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["stance_change"]		= %ai_pillar_crouch_idle_2_stand_idle;

	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["grenade_exposed"]		= %ai_pillar_crouch_grenade_throw_02;
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["grenade_safe"]		= %ai_pillar_crouch_grenade_throw_03;
	array[animType]["cover_pillar_right"]["crouch"]["rifle"]["grenade_throw"]		= %crouch_grenade_throw;

	array[animType]["pain"]["crouch"]["rifle"]["cover_pillar_r_remain"]				= %ai_pillar_crouch_pain_r_remain;
	array[animType]["pain"]["crouch"]["rifle"]["cover_pillar_r_return"]				= %ai_pillar_crouch_pain_r_return;	

	array[animType]["death"]["crouch"]["rifle"]["cover_pillar_front"]				= array( %ai_pillar_crouch_death_idle_01, %ai_pillar_crouch_death_idle_02 );
	array[animType]["death"]["crouch"]["rifle"]["cover_pillar_left"]				= array( %ai_pillar_crouch_death_left_01, %ai_pillar_crouch_death_left_02 );
	array[animType]["death"]["crouch"]["rifle"]["cover_pillar_right"]				= array( %ai_pillar_crouch_death_right_01, %ai_pillar_crouch_death_right_02 );
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	array[animType]["pain"]["stand"]["pistol"]["groin"]						= %pistol_stand_pain_groin;
	...
	array[animType]["pain"]["stand"]["rifle"]["chest_front"]				= %minorpain_chest_front;
	array[animType]["pain"]["stand"]["rifle"]["chest_back"]					= %minorpain_chest_back;
	array[animType]["pain"]["stand"]["rifle"]["chest_left"]					= %minorpain_chest_left;
	array[animType]["pain"]["stand"]["rifle"]["chest_right"]				= %minorpain_chest_right;
	array[animType]["pain"]["stand"]["rifle"]["head_front"]					= %minorpain_head_front;
	array[animType]["pain"]["stand"]["rifle"]["head_back"]					= %minorpain_head_back;
	array[animType]["pain"]["stand"]["rifle"]["head_left"]					= %minorpain_head_left;
	array[animType]["pain"]["stand"]["rifle"]["head_right"]					= %minorpain_head_right;
	array[animType]["pain"]["stand"]["rifle"]["left_arm_front"]				= %minorpain_chest_front;
	array[animType]["pain"]["stand"]["rifle"]["left_arm_back"]				= %minorpain_chest_back;
	array[animType]["pain"]["stand"]["rifle"]["left_arm_left"]				= %minorpain_chest_left;
	array[animType]["pain"]["stand"]["rifle"]["left_arm_right"]				= %minorpain_chest_right;
	array[animType]["pain"]["stand"]["rifle"]["right_arm_front"]			= %minorpain_chest_front;
	array[animType]["pain"]["stand"]["rifle"]["right_arm_back"]				= %minorpain_chest_back;
	array[animType]["pain"]["stand"]["rifle"]["right_arm_left"]				= %minorpain_chest_left;
	array[animType]["pain"]["stand"]["rifle"]["right_arm_right"]			= %minorpain_chest_right;
	...
	array[animType]["pain"]["stand"]["rifle"]["run_chest"]					= array( %run_pain_fallonknee, %run_pain_fallonknee_02, %run_pain_fallonknee_03, %run_pain_stomach, %run_pain_stumble );
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// End Exposed Pains
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//array[animType]["react"]["stand"]["rifle"]["cover_left_head"]			= %ai_stand_corner_left_miss_detect_head; 
	//array[animType]["react"]["stand"]["rifle"]["cover_left_upper_torso"]    = %ai_stand_corner_left_miss_detect_torso;
	//array[animType]["react"]["stand"]["rifle"]["cover_left_lower_torso"]	= %ai_stand_corner_left_miss_detect_legs;
	
	//array[animType]["react"]["crouch"]["rifle"]["cover_left_head"]			= %ai_crouch_corner_left_miss_detect_head; 
	//array[animType]["react"]["crouch"]["rifle"]["cover_left_upper_torso"]   = %ai_crouch_corner_left_miss_detect_torso;
	//array[animType]["react"]["crouch"]["rifle"]["cover_left_lower_torso"]	= %ai_crouch_corner_left_miss_detect_low;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//array[animType]["react"]["stand"]["rifle"]["cover_right_head"]			= %ai_stand_corner_right_miss_detect_head;	
	//array[animType]["react"]["stand"]["rifle"]["cover_right_upper_torso"]	= %ai_stand_corner_right_miss_detect_torso;
	//array[animType]["react"]["stand"]["rifle"]["cover_right_lower_torso"]	= %ai_stand_corner_right_miss_detect_legs;

	//array[animType]["react"]["crouch"]["rifle"]["cover_right_head"]			= %ai_crouch_corner_right_miss_detect_head;	
	//array[animType]["react"]["crouch"]["rifle"]["cover_right_upper_torso"]	= %ai_crouch_corner_right_miss_detect_torso;
	//array[animType]["react"]["crouch"]["rifle"]["cover_right_lower_torso"]	= %ai_crouch_corner_right_miss_detect_low;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//array[animType]["react"]["stand"]["rifle"]["cover_stand_head"]			= %ai_stand_cover_hide_miss_detect_head; 
	//array[animType]["react"]["stand"]["rifle"]["cover_stand_upper_torso"]   = %ai_stand_cover_hide_miss_detect_torso;
	//array[animType]["react"]["stand"]["rifle"]["cover_stand_lower_torso"]	= %ai_stand_cover_hide_miss_detect_legs;

	//array[animType]["react"]["crouch"]["rifle"]["cover_stand_head"]			= %ai_crouch_cover_hide_miss_detect_head; 
	//array[animType]["react"]["crouch"]["rifle"]["cover_stand_upper_torso"]  = %ai_crouch_cover_hide_miss_detect_torso;
	//array[animType]["react"]["crouch"]["rifle"]["cover_stand_lower_torso"]	= %ai_crouch_cover_hide_miss_detect_legs;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	array[animType]["death"]["stand"]["rifle"]["firing_2"]					= %exposed_death_firing_02;
	...
	array[animType]["death"]["stand"]["rifle"]["flyback"]					= %ai_death_flyback;				// explosive/shotgun front hit, fly backwards
	array[animType]["death"]["stand"]["rifle"]["flyback_far"]				= %ai_death_flyback_far;			// explosive/shotgun front hit, fly backwards
	...
	array[animType]["death"]["stand"]["rifle"]["jackiespin_left"]			= %ai_death_jackiespin_left;		// explosive/shotgun right hit, fly left
	array[animType]["death"]["stand"]["rifle"]["jackiespin_right"]			= %ai_death_jackiespin_right;		// explosive/shotgun left hit, fly right
	array[animType]["death"]["stand"]["rifle"]["jackiespin_vertical"]		= %ai_death_jackiespin_vertical;	// explosive/shotgun back hit, fly forward
	array[animType]["death"]["stand"]["rifle"]["heavy_flyback"]				= %ai_death_stand_heavyshot_back;	// explosive/shotgun back hit, fall forward	

	array[animType]["death"]["stand"]["rifle"]["faceplant"]					= %ai_death_faceplant;				// sniper hit back/legs, fall forward
	array[animType]["death"]["stand"]["rifle"]["flatonback"]				= %ai_death_flatonback;				// sniper hit front, fall backward
	array[animType]["death"]["stand"]["rifle"]["legsout_left"]				= %ai_death_legsout_left;			// sniper hit left, fall right
	array[animType]["death"]["stand"]["rifle"]["legsout_right"]				= %ai_death_legsout_right;			// sniper hit right, fall left
	array[animType]["death"]["stand"]["rifle"]["upontoback"]				= %ai_death_flatonback;				// sniper hit headshot, fall backward
	...
	array[animType]["death"]["stand"]["rifle"]["bayonet_back"]				= %ai_bayonet_back_death;
	array[animType]["death"]["stand"]["rifle"]["bayonet_right"]				= %ai_bayonet_right_death;
	array[animType]["death"]["stand"]["rifle"]["bayonet_left"]				= %ai_bayonet_left_death;
	array[animType]["death"]["stand"]["rifle"]["bayonet_head"]				= %ai_bayonet_shoulder_death;
	array[animType]["death"]["stand"]["rifle"]["bayonet_front"]				= %ai_bayonet_thrust_death;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	array[animType]["turn"]["stand"]["rifle"]["turn_f_l_180"]				= %ai_run_lowready_f_turn_180_l;
	...
	array[animType]["turn"]["stand"]["rifle"]["turn_f_r_180"]				= %ai_run_lowready_f_turn_180_r;
	...
	// SUMEET_TODO - we need this animation cqb specific
	array[animType]["turn"]["stand"]["rifle"]["turn_b_l_180_cqb"]			= %ai_run_b2f;
	array[animType]["turn"]["stand"]["rifle"]["turn_b_r_180_cqb"]			= %ai_run_b2f_a;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	array[animType]["turn"]["stand"]["rifle"]["turn_f_l_180"]				= %civilian_run_upright_turn180;
	...
	array[animType]["turn"]["stand"]["rifle"]["turn_f_r_180"]				= %civilian_run_upright_turn180;
...
// Begin Cover Arrival Actions
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["arrive_exposed"][2]			= %ai_viet_run_2_stand_f_wounded;
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["arrive_exposed"][4]			= %ai_viet_run_2_stand_90_l_wounded;
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["arrive_exposed"][6]			= %ai_viet_run_2_stand_90_r_wounded;
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["arrive_exposed"][8]			= %ai_viet_run_2_stand_180_l_wounded;
...
// Begin Cover Exit Actions
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["exit_exposed"][2]				= %ai_viet_stand_2_run_180_l_wounded;
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["exit_exposed"][4]				= %ai_viet_stand_2_run_l_wounded;
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["exit_exposed"][6]				= %ai_viet_stand_2_run_r_wounded;
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["exit_exposed"][8]				= %ai_viet_stand_2_run_f_wounded;
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// run forward turns
	self.anim_array[self.animType]["turn"]["stand"]["rifle"]["turn_f_l_45"]					= %ai_viet_run_lowready_f_turn_45_l_wounded;
	self.anim_array[self.animType]["turn"]["stand"]["rifle"]["turn_f_l_90"]					= %ai_viet_run_lowready_f_turn_90_l_wounded;
	self.anim_array[self.animType]["turn"]["stand"]["rifle"]["turn_f_l_180"]				= %ai_viet_run_lowready_f_turn_180_l_wounded;
	self.anim_array[self.animType]["turn"]["stand"]["rifle"]["turn_f_r_45"]					= %ai_viet_run_lowready_f_turn_45_r_wounded;
	self.anim_array[self.animType]["turn"]["stand"]["rifle"]["turn_f_r_90"]					= %ai_viet_run_lowready_f_turn_90_r_wounded;
	self.anim_array[self.animType]["turn"]["stand"]["rifle"]["turn_f_r_180"]				= %ai_viet_run_lowready_f_turn_180_r_wounded;
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// End Turn Actions
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
// Begin Run Actions
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["combat_run_f"]				= %ai_viet_run_f_wounded;
	...
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["run_n_gun_f"]					= %ai_viet_run_f_wounded;
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["run_n_gun_r"]					= %ai_viet_run_r_wounded;
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["run_n_gun_l"]					= %ai_viet_run_l_wounded;
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["run_n_gun_b"]					= %ai_viet_run_b_wounded;

	self.anim_array[self.animType]["move"]["stand"]["rifle"]["add_f_aim_up"]				= %ai_viet_run_f_wounded_aim_8;
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["add_f_aim_down"]				= %ai_viet_run_f_wounded_aim_2;
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["add_f_aim_left"]				= %ai_viet_run_f_wounded_aim_4;
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["add_f_aim_right"]				= %ai_viet_run_f_wounded_aim_6;

	self.anim_array[self.animType]["move"]["stand"]["rifle"]["combat_run_lean_l"]			= %ai_viet_run_f_wounded_lean_l;
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["combat_run_lean_r"]			= %ai_viet_run_f_wounded_lean_r;
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// End Run Actions
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
setup_anim_array( animType )
{
	...
	switch( animType )
	{
		...
		case "civilian":
			anim.anim_array = setup_civilian_anim_array( animType, anim.anim_array );
			break;
...
// SUMEET_TODO - These are temp animations, shuoldnt need this once we get faction specific ones.
setup_default_rusher_anim_array()
{
	...
	{	
		// replace run cycles
		self.anim_array[self.animType]["move"]["stand"]["rifle"]["combat_run_f"]	= %ai_rusher_semi_run_lowready_F;
		self.anim_array[self.animType]["move"]["stand"]["rifle"]["combat_run_r"]	= %ai_rusher_semi_run_lowready_R;
		self.anim_array[self.animType]["move"]["stand"]["rifle"]["combat_run_l"]	= %ai_rusher_semi_run_lowready_L;
		self.anim_array[self.animType]["move"]["stand"]["rifle"]["combat_run_b"]	= %ai_rusher_semi_run_lowready_B;
			
		// replace run and gun animations
		self.anim_array[self.animType]["move"]["stand"]["rifle"]["run_n_gun_f"]		= %ai_rusher_semi_run_n_gun_F;
		self.anim_array[self.animType]["move"]["stand"]["rifle"]["run_n_gun_r"]		= %ai_rusher_semi_run_n_gun_R;
		self.anim_array[self.animType]["move"]["stand"]["rifle"]["run_n_gun_l"]		= %ai_rusher_semi_run_n_gun_L;
		self.anim_array[self.animType]["move"]["stand"]["rifle"]["run_n_gun_b"]		= %ai_rusher_semi_run_n_gun_B;

		// replace lean animations
		self.anim_array[self.animType]["move"]["stand"]["rifle"]["combat_run_lean_l"]	= %ai_rusher_semi_run_lowready_L;
		self.anim_array[self.animType]["move"]["stand"]["rifle"]["combat_run_lean_r"]	= %ai_rusher_semi_run_lowready_R;
	}
	...
	else if( self.rusherType == "pistol" )
	{
		...
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["fire"]					= %ai_pistol_rusher_stand_exposed_shoot_semi1;
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["single"]				= array( %ai_pistol_rusher_stand_exposed_shoot_semi1 );
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["semi1"]				= %ai_pistol_rusher_stand_exposed_shoot_semi1;
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["semi2"]				= %ai_pistol_rusher_stand_exposed_shoot_semi2;
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["semi3"]				= %ai_pistol_rusher_stand_exposed_shoot_semi3;
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["semi4"]				= %ai_pistol_rusher_stand_exposed_shoot_semi4;
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["semi5"]				= %ai_pistol_rusher_stand_exposed_shoot_semi5;

		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["straight_level"]		= %ai_pistol_rusher_stand_exposed_aim5;
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["add_aim_up"]			= %ai_pistol_rusher_stand_exposed_aim8;
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["add_aim_down"]			= %ai_pistol_rusher_stand_exposed_aim2;
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["add_aim_left"]			= %ai_pistol_rusher_stand_exposed_aim4;
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["add_aim_right"]		= %ai_pistol_rusher_stand_exposed_aim6;  

		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["exposed_idle"]				= array( %ai_pistol_rusher_stand_exposed_idle );
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["exposed_idle_noncombat"]	= array( %ai_pistol_rusher_stand_exposed_idle );

		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["turn_left_45"]			= %ai_pistol_rusher_stand_exposed_turn_45_l;
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["turn_left_90"]			= %ai_pistol_rusher_stand_exposed_turn_90_l;
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["turn_left_135"]		= %ai_pistol_rusher_stand_exposed_turn_135_l;
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["turn_left_180"]		= %ai_pistol_rusher_stand_exposed_turn_135_r;
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["turn_right_45"]		= %ai_pistol_rusher_stand_exposed_turn_45_r;
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["turn_right_90"]		= %ai_pistol_rusher_stand_exposed_turn_90_r;
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["turn_right_135"]		= %ai_pistol_rusher_stand_exposed_turn_135_r;
		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["turn_right_180"]		= %ai_pistol_rusher_stand_exposed_turn_180_r;

		self.anim_array[self.animType]["combat"]["stand"]["pistol"]["reload"]				= array( %ai_pistol_rusher_stand_exposed_reload );

		self.anim_array[self.animType]["pain"]["stand"]["pistol"]["chest"]					= %ai_pistol_rusher_stand_exposed_pain_chest;
		self.anim_array[self.animType]["pain"]["stand"]["pistol"]["groin"]					= %ai_pistol_rusher_stand_exposed_pain_groin;
		self.anim_array[self.animType]["pain"]["stand"]["pistol"]["head"]					= %ai_pistol_rusher_stand_exposed_pain_head;
		self.anim_array[self.animType]["pain"]["stand"]["pistol"]["left_arm"]				= %ai_pistol_rusher_stand_exposed_pain_chest;
		self.anim_array[self.animType]["pain"]["stand"]["pistol"]["right_arm"]				= %ai_pistol_rusher_stand_exposed_pain_chest;

		self.anim_array[self.animType]["pain"]["stand"]["rifle"]["run_chest"]				= array( %ai_pistol_rusher_run_f_pain_chest, %ai_pistol_rusher_run_f_pain_groin, %ai_pistol_rusher_run_f_pain_leftleg_stumble );

		self.anim_array[self.animType]["move"]["stand"]["pistol"]["run_n_gun_f"]			= %ai_pistol_rusher_run_f;
		self.anim_array[self.animType]["move"]["stand"]["pistol"]["run_n_gun_r"]			= %ai_pistol_rusher_run_r;
		self.anim_array[self.animType]["move"]["stand"]["pistol"]["run_n_gun_l"]			= %ai_pistol_rusher_run_l;
		self.anim_array[self.animType]["move"]["stand"]["pistol"]["run_n_gun_b"]			= %ai_pistol_rusher_run_b;

		self.anim_array[self.animType]["move"]["stand"]["pistol"]["combat_run_f"]			= %ai_pistol_rusher_run_f;
		self.anim_array[self.animType]["move"]["stand"]["pistol"]["combat_run_r"]			= %ai_pistol_rusher_run_r;
		self.anim_array[self.animType]["move"]["stand"]["pistol"]["combat_run_l"]			= %ai_pistol_rusher_run_l;
		self.anim_array[self.animType]["move"]["stand"]["pistol"]["combat_run_b"]			= %ai_pistol_rusher_run_b;

		self.anim_array[self.animType]["move"]["stand"]["pistol"]["add_f_aim_up"]			= %ai_pistol_rusher_run_f_aim8;
		self.anim_array[self.animType]["move"]["stand"]["pistol"]["add_f_aim_down"]			= %ai_pistol_rusher_run_f_aim2;
		self.anim_array[self.animType]["move"]["stand"]["pistol"]["add_f_aim_left"]			= %ai_pistol_rusher_run_f_aim4;
		self.anim_array[self.animType]["move"]["stand"]["pistol"]["add_f_aim_right"]		= %ai_pistol_rusher_run_f_aim6;

		self.anim_array[self.animType]["move"]["stand"]["pistol"]["start_stand_run_f"]		= %ai_pistol_rusher_run_f;
		self.anim_array[self.animType]["move"]["crouch"]["pistol"]["start_stand_run_f"]		= %ai_pistol_rusher_run_f;
		self.anim_array[self.animType]["move"]["prone"]["pistol"]["start_stand_run_f"]		= %ai_pistol_rusher_run_f;

		self.anim_array[self.animType]["move"]["stand"]["pistol"]["fire"]					= %ai_pistol_rusher_stand_exposed_shoot_semi1;
		self.anim_array[self.animType]["move"]["stand"]["pistol"]["single"]					= array( %ai_pistol_rusher_stand_exposed_shoot_semi1 );
		self.anim_array[self.animType]["move"]["stand"]["pistol"]["semi1"]					= %ai_pistol_rusher_stand_exposed_shoot_semi1;
		self.anim_array[self.animType]["move"]["stand"]["pistol"]["semi2"]					= %ai_pistol_rusher_stand_exposed_shoot_semi2;
		self.anim_array[self.animType]["move"]["stand"]["pistol"]["semi3"]					= %ai_pistol_rusher_stand_exposed_shoot_semi3;
		self.anim_array[self.animType]["move"]["stand"]["pistol"]["semi4"]					= %ai_pistol_rusher_stand_exposed_shoot_semi4;
		self.anim_array[self.animType]["move"]["stand"]["pistol"]["semi5"]					= %ai_pistol_rusher_stand_exposed_shoot_semi5;

		self.anim_array[self.animType]["stop"]["stand"]["pistol"]["idle_trans"]				= %ai_pistol_rusher_stand_exposed_aim5;
		self.anim_array[self.animType]["stop"]["stand"]["pistol"]["idle"]					= array( array(%ai_pistol_rusher_stand_exposed_aim5) );
	}
}
...
reset_default_rusher_anim_array()
{
	...
	AssertEx( self.rusher == true, "This AI is not a rusher." );
	...
	// set lean animations to default
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["combat_run_lean_l"]	= undefined;
	self.anim_array[self.animType]["move"]["stand"]["rifle"]["combat_run_lean_r"]	= undefined;
...
setup_rusher_anims()
{
	...
	{
		case "vc":
			self animscripts\anims_table_vc::setup_vc_rusher_anim_array();
			break;
...
setup_rusher_wounded_anim()
{
	switch( self.animType )
	{
		...
		case "spetsnaz":
			// do nothing for now
			//self setup_default_rusher_wounded_anim();
			break;

		case "vc":
			self animscripts\anims_table_vc::setup_vc_rusher_wounded_anim();
			break;
	}
}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// LEVEL SPECIFIC ANIMSETS
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////


// Prisoners for Vorkuta
setup_prisoner_anims()
{
	self setup_prisoner_anim_array();
}

reset_prisoner_anims()
{
	self reset_default_prisoner_anim_array();
}

setup_prisoner_anim_array()
{
	self animscripts\anims::clearAnimCache();
	...
	self.anim_array[self.animType]["react"]["stand"]["none"]["run_head"]		            = %ai_prisoner_run_hunched_flinch; 
	self.anim_array[self.animType]["react"]["stand"]["none"]["run_lower_torso_fast"]		= %ai_prisoner_run_hunched_flinch;
	self.anim_array[self.animType]["react"]["stand"]["none"]["run_lower_torso_stop"]		= %ai_prisoner_run_hunched_dodge;
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// run forward turns
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_f_l_45"]				= %ai_prisoner_run_hunched_turn_l45;
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_f_l_90"]				= %ai_prisoner_run_hunched_turn_l90;
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_f_l_180"]			= %ai_prisoner_run_upright_turn_l180;
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_f_r_45"]				= %ai_prisoner_run_upright_turn_r45;
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_f_r_90"]				= %ai_prisoner_run_upright_turn_r90;
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_f_r_180"]			= %ai_prisoner_run_upright_turn_r180;

	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_b_l_180"]			= %ai_prisoner_run_upright_turn_r180;
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_b_r_180"]			= %ai_prisoner_run_upright_turn_r180;
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// End Turn Actions
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// Begin Stop Actions
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	self.anim_array[self.animType]["stop"]["stand"]["none"]["idle"]					= array( array( %ai_prisoner_stand_idle ) );
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// End Stop Actions
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

	self.anim_array[self.animType]["stop"]["stand"]["none"]["idle_trans"]				= %ai_prisoner_stand_idle;
	self.anim_array[self.animType]["combat"]["stand"]["none"]["exposed_idle"]			= array( %ai_prisoner_stand_idle );
	self.anim_array[self.animType]["combat"]["stand"]["none"]["exposed_idle_noncombat"]	= array( %ai_prisoner_stand_idle );
	self.anim_array[self.animType]["combat"]["stand"]["none"]["straight_level"]			= %ai_prisoner_stand_idle;

	// we need 45 degree angle approaches for exposed...
	self.anim_array[self.animType]["move"]["stand"]["none"]["exit_exposed"][2]			= %ai_civ_gen_alert_stand_idle_2_run_b;
	self.anim_array[self.animType]["move"]["stand"]["none"]["exit_exposed"][4]			= %ai_civ_gen_alert_stand_idle_2_run_l;
	self.anim_array[self.animType]["move"]["stand"]["none"]["exit_exposed"][6]			= %ai_civ_gen_alert_stand_idle_2_run_r;
	self.anim_array[self.animType]["move"]["stand"]["none"]["exit_exposed"][8]			= %ai_prisoner_stand2run;

	// we need 45 degree angle approaches for exposed...
	self.anim_array[self.animType]["move"]["stand"]["none"]["arrive_exposed"][2]		= %ai_prisoner_run2stand;
	self.anim_array[self.animType]["move"]["stand"]["none"]["arrive_exposed"][4]		= %ai_civilian_run_2_stand_90L;
	self.anim_array[self.animType]["move"]["stand"]["none"]["arrive_exposed"][6]		= %ai_civilian_run_2_stand_90R;
	self.anim_array[self.animType]["move"]["stand"]["none"]["arrive_exposed"][8]		= %ai_civilian_run_2_stand_180L;

	self.anim_array[self.animType]["move"]["stand"]["none"]["mantle_over_96"]			= %ai_prisoner_mantle_over_96;
}

reset_default_prisoner_anim_array()
{
	self animscripts\anims::clearAnimCache();
	...
	self.anim_array[self.animType]["react"]["stand"]["none"]["run_head"]		        = undefined; 
	self.anim_array[self.animType]["react"]["stand"]["none"]["run_lower_torso_fast"]   = undefined;
	self.anim_array[self.animType]["react"]["stand"]["none"]["run_lower_torso_stop"]   = undefined;
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// run forward turns
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_f_l_45"]				= undefined;
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_f_l_90"]				= undefined;
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_f_l_180"]			= undefined;
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_f_r_45"]				= undefined;
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_f_r_90"]				= undefined;
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_f_r_180"]			= undefined;

	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_b_l_180"]			= undefined;
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_b_r_180"]			= undefined;
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// End Turn Actions
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	self.anim_array[self.animType]["stop"]["stand"]["none"]["idle_trans"]				= undefined;
	self.anim_array[self.animType]["combat"]["stand"]["none"]["exposed_idle"]			= undefined;
	self.anim_array[self.animType]["combat"]["stand"]["none"]["exposed_idle_noncombat"]	= undefined;
	self.anim_array[self.animType]["combat"]["stand"]["none"]["straight_level"]			= undefined;

	// we need 45 degree angle approaches for exposed...
	self.anim_array[self.animType]["move"]["stand"]["none"]["exit_exposed"][2]			= undefined;
	self.anim_array[self.animType]["move"]["stand"]["none"]["exit_exposed"][4]			= undefined;
	self.anim_array[self.animType]["move"]["stand"]["none"]["exit_exposed"][6]			= undefined;
	self.anim_array[self.animType]["move"]["stand"]["none"]["exit_exposed"][8]			= undefined;

	// we need 45 degree angle approaches for exposed...
	self.anim_array[self.animType]["move"]["stand"]["none"]["arrive_exposed"][2]		= undefined;
	self.anim_array[self.animType]["move"]["stand"]["none"]["arrive_exposed"][4]		= undefined;
	self.anim_array[self.animType]["move"]["stand"]["none"]["arrive_exposed"][6]		= undefined;
	self.anim_array[self.animType]["move"]["stand"]["none"]["arrive_exposed"][8]		= undefined;
}

// sergei for vorkuta
setup_sergei_anim_array()
{
	self animscripts\anims::clearAnimCache();
	...
	self.anim_array[self.animType]["react"]["stand"]["none"]["run_head"]		            = %ai_sergei_run_hunched_flinch; 
	self.anim_array[self.animType]["react"]["stand"]["none"]["run_lower_torso_fast"]       = %ai_sergei_run_hunched_flinch;
	self.anim_array[self.animType]["react"]["stand"]["none"]["run_lower_torso_stop"]       = %ai_sergei_run_hunched_dodge;
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// run forward turns
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_f_l_45"]				= %ai_sergei_run_hunched_turnL45;
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_f_l_90"]				= %ai_sergei_run_hunched_turnL90;
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_f_l_180"]			= %ai_sergei_run_upright_turn180;
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_f_r_45"]				= %ai_sergei_run_upright_turnR45;
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_f_r_90"]				= %ai_sergei_run_upright_turnR90;
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_f_r_180"]			= %ai_sergei_run_upright_turn180;

	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_b_l_180"]			= %ai_sergei_run_upright_turn180;
	self.anim_array[self.animType]["turn"]["stand"]["none"]["turn_b_r_180"]			= %ai_sergei_run_upright_turn180;
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// End Turn Actions
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// Begin Stop Actions
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	self.anim_array[self.animType]["stop"]["stand"]["none"]["idle"]					= array( array( %ai_sergei_stand_idle ) );
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// End Stop Actions
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

	self.anim_array[self.animType]["stop"]["stand"]["none"]["idle_trans"]				= %ai_sergei_stand_idle;
	self.anim_array[self.animType]["combat"]["stand"]["none"]["exposed_idle"]			= array( %ai_sergei_stand_idle );
	self.anim_array[self.animType]["combat"]["stand"]["none"]["exposed_idle_noncombat"]	= array( %ai_sergei_stand_idle );
	self.anim_array[self.animType]["combat"]["stand"]["none"]["straight_level"]			= %ai_sergei_stand_idle;

	// we need 45 degree angle approaches for exposed...
	self.anim_array[self.animType]["move"]["stand"]["none"]["exit_exposed"][2]			= %ai_civ_gen_alert_stand_idle_2_run_b;
	self.anim_array[self.animType]["move"]["stand"]["none"]["exit_exposed"][4]			= %ai_civ_gen_alert_stand_idle_2_run_l;
	self.anim_array[self.animType]["move"]["stand"]["none"]["exit_exposed"][6]			= %ai_civ_gen_alert_stand_idle_2_run_r;
	self.anim_array[self.animType]["move"]["stand"]["none"]["exit_exposed"][8]			= %ai_sergei_stand2run;


	// we need 45 degree angle approaches for exposed...
	self.anim_array[self.animType]["move"]["stand"]["none"]["arrive_exposed"][2]			= %ai_sergei_run2stand;
	self.anim_array[self.animType]["move"]["stand"]["none"]["arrive_exposed"][4]			= %ai_civilian_run_2_stand_90L;
	self.anim_array[self.animType]["move"]["stand"]["none"]["arrive_exposed"][6]			= %ai_civilian_run_2_stand_90R;
	self.anim_array[self.animType]["move"]["stand"]["none"]["arrive_exposed"][8]			= %ai_civilian_run_2_stand_180L;
...
setup_baton_guard_anim_array()
{
	...
	self.anim_array[self.animType]["combat"]["stand"]["none"]["melee"]					= %ai_baton_melee_1;
	self.anim_array[self.animType]["combat"]["stand"]["none"]["stand_2_melee"]			= %ai_baton_stand_2_melee_1;
	self.anim_array[self.animType]["combat"]["stand"]["none"]["run_2_melee"]			= %ai_baton_run_2_melee_charge;

	self.anim_array[self.animType]["combat"]["stand"]["none"]["run_n_gun_f"]			= %ai_baton_run_f;
	self.anim_array[self.animType]["combat"]["stand"]["none"]["combat_run_f"]			= %ai_baton_run_f;

	self.anim_array[self.animType]["stop"]["stand"]["none"]["idle_trans"]				= %ai_baton_stand_idle;
	self.anim_array[self.animType]["stop"]["stand"]["none"]["idle"]						= array( array(%ai_baton_stand_idle) );
	self.anim_array[self.animType]["combat"]["stand"]["none"]["exposed_idle"]			= array( %ai_baton_stand_idle );
	self.anim_array[self.animType]["combat"]["stand"]["none"]["exposed_idle_noncombat"]	= array( %ai_baton_stand_idle );
	self.anim_array[self.animType]["combat"]["stand"]["none"]["straight_level"]			= %ai_baton_stand_idle;
}
