...
//	println( self GetEntNum() + ": unpause (time: " + GetTime() + ")" );
}
...
//		println( self GetEntNum() + ": pause (time: " + GetTime() + ")" );
	}
}
...
trackLoop()
{
	...
	for(;;)
	{
		...
		{
			recordEntText( "actualAngle: " + shootFromAngles[0] + " shootFromPitchAngle: " + shootFromPitchAngle + " shootFromPitchDelta: " + shootFromPitchDelta, self, level.color_debug["cyan"], "Script" );
			recordEntText( "actualAngle: " + shootFromAngles[1] + " shootFromYawAngle: " + shootFromYawAngle + " shootFromYawDelta: " + shootFromYawDelta, self, level.color_debug["orange"], "Script" );
		...
		if(GetDvarInt( #"ai_debugAiming"))
		{
			...
			recordLine( shootFromPos, shootFromPos + vector_scale(facingVector, 100), (0,1,0), "Script", self );

			if( IsDefined(shootPos) )
			{
				recordLine( shootFromPos, shootPos, (1,0,0), "Script", self );
			}
		}
		#/
		///////////////
...
//		}
		...
		if(GetDvarInt( #"ai_debugAiming"))
		{
			recordEntText( "pitchDelta: " + pitchDelta, self, level.color_debug["cyan"], "Script" );
			recordEntText( "yawDelta: " + yawDelta, self, level.color_debug["orange"], "Script" );
		}
		#/		
