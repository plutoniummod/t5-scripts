...
matches_me()
{
	if(self.model == "c_rus_military_winter_body1")
	{
		return true;
	}
...
register_gibs()
{
	...
	gib_spawn.gibSpawn1 = "c_rus_spetznaz_winter_body1_g_rarmspawn";
	gib_spawn.gibSpawnTag1 = "J_Elbow_RI";
	gib_spawn.gibSpawn2 = "c_rus_spetznaz_winter_body1_g_larmspawn";
