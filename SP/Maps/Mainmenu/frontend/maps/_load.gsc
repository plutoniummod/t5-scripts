...
main( bScriptgened,bCSVgened,bsgenabled )
{
	...
	/#
	debug_replay( "File: _load.gsc. Function: main()\n" ); 
	#/

	// set up campaign specific overloaded funcs
/*	register_overloaded_func( "maps\_arcademode", "main", maps\_arcademode::main );
	register_overloaded_func( "maps\_arcademode", "arcademode_complete", maps\_arcademode::arcademode_complete );
	register_overloaded_func( "maps\_arcademode", "arcademode_checkpoint_save", maps\_arcademode::arcademode_checkpoint_save );
	register_overloaded_func( "maps\_arcademode", "arcademode_checkpoint_restore", maps\_arcademode::arcademode_checkpoint_restore );
	register_overloaded_func( "maps\_arcademode", "arcademode_ends", maps\_arcademode::arcademode_ends );
	register_overloaded_func( "maps\_arcademode", "arcademode_player_laststand", maps\_arcademode::arcademode_player_laststand );
	register_overloaded_func( "maps\_arcademode", "arcademode_player_revive", maps\_arcademode::arcademode_player_revive );
	register_overloaded_func( "maps\_arcademode", "arcademode_assignpoints_toplayer", maps\_arcademode::arcademode_assignpoints_toplayer );

	register_overloaded_func( "maps\_quotes", "main", maps\_quotes::main );
	register_overloaded_func( "maps\_quotes", "displayMissionFailed", maps\_quotes::displayMissionFailed );
	register_overloaded_func( "maps\_quotes", "displayPlayerDead", maps\_quotes::displayPlayerDead );
	register_overloaded_func( "maps\_quotes", "displayTeammateDead", maps\_quotes::displayTeammateDead );*/
...
//	trigger_funcs["trigger_coop_warp"] = maps\_utility::trigger_coop_warp;
	...
	/#
	debug_replay( "File: _load.gsc. Function: main() - COMPLETE\n" ); 
	#/
...
{
	/#
	debug_replay( "File: _load.gsc. Function: onPlayerSpawned()\n" ); 
	#/
	...
	{
		/#
		debug_replay( "File: _load.gsc. Function: onPlayerSpawned() - INNER LOOP START\n" ); 

		debug_replay( "File: _load.gsc. Function: onPlayerSpawned() - INNER LOOP START WAIT\n" ); 
		#/

		self waittill( "spawned_player" ); 

		/#
		debug_replay( "File: _load.gsc. Function: onPlayerSpawned() - 3\n" ); 
		#/
		...
		/#
		debug_replay( "File: _load.gsc. Function: onPlayerSpawned() - 4\n" ); 
		#/
...
//			self thread maps\_quotes::main(); 	-- Removed by DSL 4/3/2010 2:08:46 PM
		...
		/#
		debug_replay( "File: _load.gsc. Function: onPlayerSpawned() - 5\n" ); 
		#/
	}
}
...
{
	/#
	debug_replay( "File: _load.gsc. Function: handle_starts()\n" ); 
	#/
	...
	/#
	debug_replay( "File: _load.gsc. Function: handle_starts() - WAITING FOR FIRST PLAYER\n" ); 
	#/
	
	wait_for_first_player(); 
	
	/#
	debug_replay( "File: _load.gsc. Function: handle_starts() - FOUND FIRST PLAYER\n" ); 
	#/
	...
	{
		//-- GLOCKE: 8/20/09: production now toggles a var when they make a build so always call the splash screen
	...
	/#
	debug_replay( "File: _load.gsc. Function: handle_starts() - COMPLETE\n" ); 
	#/
...
display_starts() 
{
	...
	{	
		/#
		debug_replay( "File: _load.gsc. Function: display_starts() - INNER LOOP START\n" ); 
		#/
		...
		/#
		debug_replay( "File: _load.gsc. Function: display_starts() - INNER LOOP END\n" ); 
		#/
		wait( 0.05 ); 
	}
