...
/*QUAKED actor_Hudson_Underwaterbase_dive (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_usa_ubase_hudson_divegear::main();
}
...
precache()
{
	character\c_usa_ubase_hudson_divegear::precache();
