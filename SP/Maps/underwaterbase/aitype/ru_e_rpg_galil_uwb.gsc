...
/*QUAKED actor_RU_e_RPG_Galil_UWB (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	self.accuracy = 1;
	self.health = 150;
	self.weapon = "rpg_uwb_sp";
	self.secondaryweapon = "galil_sp";
