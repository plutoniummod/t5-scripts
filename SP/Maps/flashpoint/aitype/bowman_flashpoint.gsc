...
/*QUAKED actor_Bowman_Flashpoint (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_usa_blackops_bowman_disguise::main();
}
...
precache()
{
	character\c_usa_blackops_bowman_disguise::precache();
