...
/*QUAKED actor_Kravchenko_Flashpoint (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_rus_kravchenko_jacket::main();
}
...
precache()
{
	character\c_rus_kravchenko_jacket::precache();
