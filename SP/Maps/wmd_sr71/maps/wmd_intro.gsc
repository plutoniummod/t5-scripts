...
give_me_my_head() //-- self == headless crew guy
{
	...
	{
		self Attach( "c_usa_sr71_groundcrew_head1");
	}
	...
	{
		self Attach( "c_usa_sr71_groundcrew_head3");
	}
	...
	{
		self Attach( "c_usa_sr71_groundcrew_head2");
	}
	...
	{
		self Attach( "c_usa_sr71_groundcrew_head4");
	}
