...
precache_player_anims()
{
	...
	// e3 nva turret dive
	level.scr_anim["player_body"]["turret_dive"] = %ch_khe_E3_nvaturretDive_player;
	level.scr_anim["player_body"]["turret_choke"][0] = %ch_khe_E3_nvaturretDive_choke_player;
	level.scr_anim["player_body"]["turret_success"] = %ch_khe_E3_nvaturretDive_success_player;
...
//	addNotetrack_customFunction("heroic_soldier02", "start_ragdoll", ::death_ragdoll, "bunker");	
	...
	// e3 nva turret dive
	level.scr_anim["nva_diver"]["turret_dive"] = %ch_khe_E3_nvaturretDive_nva01;
	level.scr_anim["nva_diver"]["turret_choke"][0] = %ch_khe_E3_nvaturretDive_choke_nva01;
	level.scr_anim["nva_diver"]["turret_success"] = %ch_khe_E3_nvaturretDive_success_nva01;
	addNotetrack_customFunction("nva_diver", "boom", ::nva_boom, "turret_success");	
...
nva_boom(guy)
{
	...
	if( is_mature() )
	{
		guy maps\khe_sanh_util::bloody_death();
	}
