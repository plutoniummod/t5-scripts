...
//	flag_init("e4_follow_woods");
	...
	level thread event4_start_downhill();
}
...
{
	AssertEx(IsDefined(spawner_name), "spawner name not defined dude");
	AssertEx(IsDefined(group_name), "group name not defined dude");
