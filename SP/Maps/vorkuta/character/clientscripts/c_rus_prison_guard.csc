...
matches_me()
{
	if(self.model == "c_rus_prison_guard_body")
	{
		return true;
	}
...
register_gibs()
{
	...
	gib_spawn.gibSpawn1 = "c_rus_prison_guard_body_g_rarmspawn";
	gib_spawn.gibSpawnTag1 = "J_Elbow_RI";
	gib_spawn.gibSpawn2 = "c_rus_prison_guard_body_g_larmspawn";
	gib_spawn.gibSpawnTag2 = "J_Elbow_LE";
	gib_spawn.gibSpawn3 = "c_rus_prison_guard_body_g_rlegspawn";
	gib_spawn.gibSpawnTag3 = "J_Knee_RI";
	gib_spawn.gibSpawn4 = "c_rus_prison_guard_body_g_llegspawn";
