...
/*QUAKED actor_RU_e_Heavy_Shotgun (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
precache()
{
	character\c_rus_heavy::precache();
