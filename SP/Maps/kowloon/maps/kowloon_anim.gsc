...
init_player_animation()
{
	...
	level.scr_model[ "player_body" ] = "viewmodel_usa_blackops_urban_player_fullbody_gwet";
	...
	level.scr_model[ "player_hands" ] = "viewmodel_usa_blackops_urban_player_gwet";
...
start_interrogation_animation( sync_node )
{
	...
	if(show_glass)
	{
		...
		{
			self setmodel("c_usa_clark_fb_bleeder");
