...
matches_me()
{
	if(self.model == "c_rus_spetsnaz_undercover_bodyb_2")
	{
		return true;
	}
...
register_gibs()
{
	...
	gib_spawn.gibSpawn3 = "c_rus_spetsnaz_undercover_bodya_1_g_rlegspawn";
	gib_spawn.gibSpawnTag3 = "J_Knee_RI";
	gib_spawn.gibSpawn4 = "c_rus_spetsnaz_undercover_bodya_1_g_llegspawn";
