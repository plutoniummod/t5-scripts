...
matches_me()
{
	if(self.model == "c_rus_spetsnaz_undercover_bodya_2_w")
	{
		return true;
	}
...
register_gibs()
{
	...
	gib_spawn.gibSpawn3 = "c_rus_spetsnaz_undercover_bodya_1_w_g_rlegspawn";
	gib_spawn.gibSpawnTag3 = "J_Knee_RI";
	gib_spawn.gibSpawn4 = "c_rus_spetsnaz_undercover_bodya_1_w_g_llegspawn";
