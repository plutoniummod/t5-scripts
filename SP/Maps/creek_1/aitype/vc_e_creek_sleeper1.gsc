...
/*QUAKED actor_VC_e_Creek_sleeper1 (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_vtn_vc2_sleeper::main();
}
...
precache()
{
	character\c_vtn_vc2_sleeper::precache();
