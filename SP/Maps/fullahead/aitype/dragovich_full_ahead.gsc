...
/*QUAKED actor_Dragovich_Full_Ahead (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_rus_dragovich_young_fb"
...
main()
{
	...
	character\c_rus_dragovich_young::main();
}
