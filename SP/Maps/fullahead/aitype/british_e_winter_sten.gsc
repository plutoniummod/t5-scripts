...
/*QUAKED actor_British_e_winter_Sten (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_brt_fullahead_soldier_fb"
...
main()
{
	...
	character\c_brt_fullahead_soldier::main();
}
