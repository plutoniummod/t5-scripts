...
/*QUAKED actor_German_e_winter_MP40_Char (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_ger_infantry_char::main();
}
...
precache()
{
	character\c_ger_infantry_char::precache();
