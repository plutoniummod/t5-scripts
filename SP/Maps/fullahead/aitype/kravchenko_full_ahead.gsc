...
/*QUAKED actor_Kravchenko_Full_Ahead (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_rus_kravchenko_young_fb"
...
main()
{
	...
	character\c_rus_kravchenko_young::main();
}
