...
/*QUAKED actor_Steiner_Full_Ahead (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_ger_steiner_fullahead_fb"
...
main()
{
	...
	character\c_ger_steiner_fullahead::main();
}
