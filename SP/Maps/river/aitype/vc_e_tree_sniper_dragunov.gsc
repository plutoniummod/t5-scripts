...
/*QUAKED actor_VC_e_tree_sniper_Dragunov (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	self.accuracy = 1;
	self.health = 150;
	self.weapon = "dragunov_tree_sniper_sp";
...
precache()
{
	...
	precacheItem("dragunov_tree_sniper_sp");
