...
/*QUAKED actor_Civilian_Russian_Engineer_Hatchet (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_rus_engineer1_hatchet::main();
}
...
precache()
{
	character\c_rus_engineer1_hatchet::precache();
