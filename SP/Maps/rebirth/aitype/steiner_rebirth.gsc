...
/*QUAKED actor_Steiner_Rebirth (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_ger_steiner_rebirth_fb"
...
main()
{
	...
	character\c_ger_steiner_rebirth::main();
}
...
precache()
{
	character\c_ger_steiner_rebirth::precache();
