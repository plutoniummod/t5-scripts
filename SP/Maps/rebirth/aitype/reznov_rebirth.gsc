...
/*QUAKED actor_Reznov_Rebirth (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_rus_reznov_rebirth::main();
}
...
precache()
{
	character\c_rus_reznov_rebirth::precache();
