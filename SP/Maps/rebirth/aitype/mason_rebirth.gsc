...
/*QUAKED actor_Mason_Rebirth (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_rebirth_mason_fb"
...
main()
{
	...
	character\c_usa_rebirth_mason::main();
}
...
precache()
{
	character\c_usa_rebirth_mason::precache();
