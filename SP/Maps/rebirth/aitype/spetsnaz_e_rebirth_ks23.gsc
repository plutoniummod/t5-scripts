...
/*QUAKED actor_Spetsnaz_e_rebirth_KS23 (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	{
	case 0:
		character\c_rus_spetznaz_rebirth_1::main();
		break;
	case 1:
		character\c_rus_spetznaz_rebirth_2::main();
		break;
	}
}
...
precache()
{
	character\c_rus_spetznaz_rebirth_1::precache();
	character\c_rus_spetznaz_rebirth_2::precache();
