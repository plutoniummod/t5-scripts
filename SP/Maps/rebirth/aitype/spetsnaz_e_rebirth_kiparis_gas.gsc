...
/*QUAKED actor_Spetsnaz_e_rebirth_Kiparis_Gas (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	{
	case 0:
		character\c_rus_spetznaz_rebirth_1_gas::main();
		break;
	case 1:
		character\c_rus_spetznaz_rebirth_2_gas::main();
		break;
	}
}
...
precache()
{
	character\c_rus_spetznaz_rebirth_1_gas::precache();
	character\c_rus_spetznaz_rebirth_2_gas::precache();
