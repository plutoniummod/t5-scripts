...
precache_player_anims()
{
	level.scr_model[ "player_body" ] 										= "viewmodel_usa_blackops_urban_player_fullbody";
	level.scr_animtree["player_body"] 									= #animtree;
	
	level.scr_model["player_hands"] 										= "viewmodel_usa_blackops_urban_player";
	...
	// Hazmat Hands
	level.scr_model["player_hands_hazmat"]								= "viewmodel_usa_hazmat_player";
	...
	// Hazmat Full Body
	level.scr_model["player_body_hazmat"]								= "viewmodel_usa_hazmat_player_fullbody";
