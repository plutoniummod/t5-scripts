...
/*QUAKED actor_Dragovich_Underwater_Base (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_rus_dragovich_old::main();
}
...
precache()
{
	character\c_rus_dragovich_old::precache();
