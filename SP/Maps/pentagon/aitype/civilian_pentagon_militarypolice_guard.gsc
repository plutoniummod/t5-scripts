...
/*QUAKED actor_Civilian_Pentagon_MilitaryPolice_Guard (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_militarypolice_body"
...
main()
{
	...
	character\c_usa_militarypolice::main();
}
...
precache()
{
	character\c_usa_militarypolice::precache();
