...
/*QUAKED actor_Civilian_Pentagon_Mason (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_usa_pent_mason::main();
}
...
precache()
{
	character\c_usa_pent_mason::precache();
