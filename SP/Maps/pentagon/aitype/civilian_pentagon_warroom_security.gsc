...
/*QUAKED actor_Civilian_Pentagon_Warroom_Security (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_pent_warroom_worker_body"
...
main()
{
	...
	character\c_usa_pent_warroom_worker3::main();
}
...
precache()
{
	character\c_usa_pent_warroom_worker3::precache();
