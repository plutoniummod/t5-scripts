...
/*QUAKED actor_Civilian_Pentagon_Warroom (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_usa_pent_warroom_worker::main();
}
...
precache()
{
	character\c_usa_pent_warroom_worker::precache();
