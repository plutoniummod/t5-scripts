...
/*QUAKED actor_Civilian_Pentagon_McNamara (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_pent_mcnamara_fb"
...
main()
{
	...
	character\c_usa_pent_mcnamara::main();
}
...
precache()
{
	character\c_usa_pent_mcnamara::precache();
