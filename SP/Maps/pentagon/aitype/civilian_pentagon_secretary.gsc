...
/*QUAKED actor_Civilian_Pentagon_Secretary (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_pent_secretary_fb"
...
main()
{
	...
	character\c_usa_pent_secretary::main();
}
...
precache()
{
	character\c_usa_pent_secretary::precache();
