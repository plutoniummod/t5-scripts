...
/*QUAKED actor_Civilian_Pentagon_Politician_Security (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
defaultmdl="c_usa_pent_politician_body"
...
main()
{
	...
	character\c_usa_pent_politician2::main();
}
...
precache()
{
	character\c_usa_pent_politician2::precache();
