...
/*QUAKED actor_Castro_Woman (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_cub_prostitute::main();
}
...
precache()
{
	character\c_cub_prostitute::precache();
