...
/*QUAKED actor_CU_e_FNFAL_RPG_STRAIGHT (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	{
	case 0:
		character\c_cub_tropas_2::main();
		break;
	case 1:
		character\c_cub_tropas_3::main();
		break;
	case 2:
		character\c_cub_tropas_4::main();
		break;
	case 3:
		character\c_cub_tropas_5::main();
		break;
	}
}
...
precache()
{
	character\c_cub_tropas_2::precache();
	character\c_cub_tropas_3::precache();
	character\c_cub_tropas_4::precache();
	character\c_cub_tropas_5::precache();
