...
/*QUAKED actor_Civilian_Cuba (0.5 0.5 0.5) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_cub_civilians::main();
}
...
precache()
{
	character\c_cub_civilians::precache();
