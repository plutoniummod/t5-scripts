...
/*QUAKED actor_Castro_Cuba_faux (1.0 0.25 0.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_cub_castro_shirt::main();
}
...
precache()
{
	character\c_cub_castro_shirt::precache();
