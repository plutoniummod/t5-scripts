...
/*QUAKED actor_Bowman_Cuba_bar (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_usa_cubcasual_bowman::main();
}
...
precache()
{
	character\c_usa_cubcasual_bowman::precache();
