...
/*QUAKED actor_Carlos_Cuba_bar (0.0 0.25 1.0) (-16 -16 0) (16 16 72) SPAWNER MAKEROOM UNDELETABLE ENEMYINFO SCRIPT_FORCESPAWN SM_PRIORITY
...
main()
{
	...
	character\c_cub_carlos_casual::main();
}
...
precache()
{
	character\c_cub_carlos_casual::precache();

	precacheItem("m16_silencer_sp");
	precacheItem("asp_sp");
