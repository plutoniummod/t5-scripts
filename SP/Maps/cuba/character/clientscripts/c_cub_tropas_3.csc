...
matches_me()
{
	if(self.model == "c_cub_tropas_body1")
	{
		return true;
	}
...
register_gibs()
{
	...
	gib_spawn.gibSpawn1 = "c_cub_tropas_body1_g_rarmspawn";
	gib_spawn.gibSpawnTag1 = "J_Elbow_RI";
	gib_spawn.gibSpawn2 = "c_cub_tropas_body1_g_larmspawn";
	gib_spawn.gibSpawnTag2 = "J_Elbow_LE";
	gib_spawn.gibSpawn3 = "c_cub_tropas_body1_g_rlegspawn";
	gib_spawn.gibSpawnTag3 = "J_Knee_RI";
	gib_spawn.gibSpawn4 = "c_cub_tropas_body1_g_llegspawn";
