...
setup_player_anims()
{
	...
	level.scr_model["player_hands"] 		    	= "viewmodel_usa_cuban_casual_fullbody";
	...
	level.scr_model["rappel_hands"]							= "viewmodel_usa_cuban_casual_player";	
...
setup_driving_anims()
{
	...
	level.scr_model["player"]		= "viewmodel_usa_cuban_casual_fullbody";

	level.scr_animtree["player_cam"]	= #animtree;
	level.scr_model["player_cam"]		= "viewmodel_usa_cuban_casual_fullbody";
